...
<?php
// Esta variable contiene la consulta SQL que se desea ejecutar.
$query = "SELECT * FROM usuarios ORDER BY id DESC";
// mysqli_query: función proporcionada por la extensión MySQLi en 
// PHP para ejecutar consultas SQL en una base de datos MySQL. 
// Se necesitan dos parámetros: el primero es la conexión de la base de datos, y el segundo es la consulta SQL que desea
// ejecutar.
